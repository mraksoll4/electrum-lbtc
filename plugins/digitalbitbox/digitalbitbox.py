...
try:
    ...
    from electrum_lbtc.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrum_lbtc.bitcoin import serialize_xpub, deserialize_xpub
    from electrum_lbtc import constants
    from electrum_lbtc.transaction import Transaction
    from electrum_lbtc.i18n import _
    from electrum_lbtc.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_lbtc.util import print_error, to_string, UserCancelled
    from electrum_lbtc.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-LBTC-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
