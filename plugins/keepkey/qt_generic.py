...
from electrum_lbtc.plugins import hook, DeviceMgr
from electrum_lbtc.util import PrintError, UserCancelled, bh2u
from electrum_lbtc.wallet import Wallet, Standard_Wallet
...
RECOMMEND_PIN = _(
    ...
    "for your litebitcoins if your device is lost or stolen.")
PASSPHRASE_NOT_PIN = _(
    "If you forget a passphrase you will be unable to access any "
    "litebitcoins in the wallet behind it.  A passphrase is not a PIN. "
    ...
    def request_trezor_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_lbtc.keystore import is_xprv
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        def wipe_device():
            ...
            if wallet and sum(wallet.get_balance()):
                ...
                msg = _("Are you SURE you want to wipe the device?\n"
                        "Your wallet still has litebitcoins in it!")
                if not self.question(msg, title=title,
        ...
        wipe_device_warning = QLabel(
            _("Only wipe a device if you have the recovery seed written down "
              "and the device wallet(s) are empty, otherwise the litebitcoins "
