...
from electrum_lbtc.util import PrintError, UserCancelled
from electrum_lbtc.keystore import bip39_normalize_passphrase
from electrum_lbtc.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        ...
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the litebitcoins in the wallet.").format(self.device)
        else:
