...
class Bitso(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json = self.get_json('api.bitso.com', '/v3/ticker/?book=lbtc_mxn')
...
class Coinbase(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json = self.get_json('api.coinbase.com',
                             '/v2/exchange-rates?currency=LBTC')
...
class OKCoin(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json = self.get_json('www.okcoin.com', '/api/v1/ticker.do?symbol=lbtc_usd')
...
class MercadoBitcoin(ExchangeBase):
    ...
    def get_rates(self,ccy):
        json = self.get_json('www.mercadobitcoin.net', '/api/lbtc/ticker/')
...
class QuadrigaCX(ExchangeBase):
    ...
    def get_rates(self,ccy):
        json = self.get_json('api.quadrigacx.com', '/v2/ticker?book=lbtc_cad')
...
class WEX(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json_eur = self.get_json('wex.nz', '/api/3/ticker/lbtc_eur')
        json_rub = self.get_json('wex.nz', '/api/3/ticker/lbtc_rur')
        json_usd = self.get_json('wex.nz', '/api/3/ticker/lbtc_usd')
