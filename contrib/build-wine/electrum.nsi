...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/electrum-lbtc-setup.exe"
...
Section
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-lbtc-${PRODUCT_VERSION}.exe" ""
  ...
  WriteRegStr HKCU "Software\Classes\litebitcoin" "URL Protocol" ""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\litebitcoin"
