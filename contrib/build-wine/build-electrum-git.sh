...
for repo in electrum-lbtc electrum-lbtc-locale electrum-lbtc-icons; do
	...
	URL=https://github.com/mraksoll4/$repo.git
	git clone -b master $URL $repo
    fi
done

pushd electrum-lbtc-locale
for i in ./locale/*; do
    dir=$i/LC_MESSAGES
    mkdir -p $dir
...
cp -r electrum-lbtc $WINEPREFIX/drive_c/electrum-lbtc
cp electrum-lbtc/LICENCE .
cp -r electrum-lbtc-locale/locale $WINEPREFIX/drive_c/electrum-lbtc/lib/
