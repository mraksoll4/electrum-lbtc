...
exe_standalone = EXE(
    ...
    a.binaries,
    a.datas, 
    name=os.path.join('build\\pyi.win32\\electrum-lbtc', cmdline_name + ".exe"),
    debug=False,
    strip=None,
    upx=False,
...
exe_portable = EXE(
    ...
    name=os.path.join('build\\pyi.win32\\electrum-lbtc', cmdline_name + "-portable.exe"),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'icons/electrum.ico',
...
exe_dependent = EXE(
    ...
    name=os.path.join('build\\pyi.win32\\electrum-lbtc', cmdline_name),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'icons/electrum.ico',
...
coll = COLLECT(
    ...
    icon=home+'icons/electrum.ico',
    console=False,
    name=os.path.join('dist', 'electrum-lbtc'))
