...
This creates a folder named Electrum-LBTC.app.
...
Copy the Electrum-LBTC.app directory over and install the dependencies, e.g.:
...
Then you can just invoke `package.sh` with the path to the app:
    ...
    cd electrum-lbtc
    ./contrib/build-osx/package.sh ~/Electrum-LBTC.app/
